    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url('/bg-blue.png')` }}>
      <div className="w-full max-w-sm bg-white rounded-lg shadow-md p-8 opacity-100">
        ...
        <form className="mt-4">
          ...
          <button type="submit" className="w-full px-4 py-2 bg-blue-700 text-white rounded-md hover:bg-blue-200">Register</button>
        </form>
        <div className="mt-4 text-center text-black">
          <p>Sudah punya akun? <a href="/login" className="text-blue-500">Login</a></p>
        </div>
      </div>
    </div>
  );
